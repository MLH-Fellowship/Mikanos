...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("react-webview.start", () => {
        ReactPanel.createOrShow(context.extensionPath, storage);
    }));
}
 ...
 */
class ReactPanel {
    constructor(extensionPath, column, storage) {
        this._disposables = [];
    ...
    static createOrShow(extensionPath, storage) {
        ...
        if (ReactPanel.currentPanel) {
            ...
            ReactPanel.currentPanel = new ReactPanel(extensionPath, column || vscode.ViewColumn.One, storage);
        }
    }
    doRefactor() {
